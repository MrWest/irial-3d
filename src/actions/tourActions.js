import { FETCH_TOURS, SELECT_TOUR, DELETE_TOUR, UPDATE_TOUR, ADD_TOUR,
  CHANGE_TOUR_PROGRAM , CHANGE_TOUR_COMMENT, ADD_TOUR_COMMENT, DELETE_TOUR_COMMENT, SET_USER_SERVICE_RATE } from "./types";
...
export const fetchTours = () => async dispatch => {
  ...
  export const updateTour = tour => async dispatch => {
    ...
    if(tour.status){
      ...
      await DashBoard.post("/tours/update_tour_status.php", statusInfo,  {headers})
    ...
    const toursDb = await DashBoard.post("/tours/update_tour.php", uploadInfo,  {headers})
  
    var tourRslt = toursDb.data
      
    const toursImagesDb = await DashBoard.get("/tours/get_tour_images.php"+ generatePHPParameters({idTour: tourRslt.id}))
    tourRslt.images = toursImagesDb.data

    const toursprogramDb = await DashBoard.get("/tours/get_tour_program.php"+ generatePHPParameters({idTour: tourRslt.id, lang}))
    tourRslt.program = toursprogramDb.data

    const tourscommentsDb = await DashBoard.get("/tours/get_tour_comments.php"+ generatePHPParameters({idTour: tourRslt.id}))
    tourRslt.comments = tourscommentsDb.data
   
    const toursvideosDb = await DashBoard.get("/tours/get_tour_videos.php"+ generatePHPParameters({idTour: tourRslt.id}))
  ...
  export const addTour = tour => async dispatch => {
    ...
    const toursDb = await DashBoard.post("/tours/add_tour.php", uploadInfo,  {headers})
  ...
  export const deleteTour = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/tours/delete_tour.php"+ generatePHPParameters({id}))
  ...
  export const uploadTourImage = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const tourAPI = await DashBoard.post("/tours/upload_tour_image.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const deleteTourImage = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/tours/delete_tour_image.php"+ generatePHPParameters({id}))
  ...
  export const uploadTourVideo = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const tourAPI = await DashBoard.post("/tours/upload_tour_video.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const deleteTourVideo = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/tours/delete_tour_video.php"+ generatePHPParameters({id}))
  ...
  export const updateTourProgram = program => async dispatch => {
    ...
    const toursDb = await DashBoard.post("/tours/update_tour_program.php", uploadInfo,  {headers})
  ...
  export const addTourProgram = program => async dispatch => {
    ...
    const toursDb = await DashBoard.post("/tours/add_tour_program.php", uploadInfo,  {headers})
  ...
  export const deleteTourProgram = id => async dispatch => {
    ...
    const toursDb = await DashBoard.post("/tours/delete_tour_program.php", uploadInfo,  {headers})
  ...
  export const updateTourComment = comment => async dispatch => {
    ...
    const commentDb = await DashBoard.post("/tours/update_tour_comment.php", uploadInfo,  {headers})
  ...
  export const addTourComment = comment => async dispatch => {
    ...
    const commentDb = await DashBoard.post("/tours/add_tour_comment.php", uploadInfo,  {headers})
    var commentRslt = commentDb.data
     dispatch({
  ...
  export const deleteTourComment = id => async dispatch => {
    ...
    await DashBoard.post("/tours/delete_tour_comment.php", uploadInfo,  {headers})
  ...
  export const sendEmail = data => async dispatch => {
    ...
    const promises = await DashBoard.post("/mail/sendemailcross.php", uploadInfo,  {headers})
  ...
  export const rateTour = info => async dispatch => {
    ...
    const lang = getLanguage();
    const toursDb = await DashBoard.post("/tours/get_tour.php"+ generatePHPParameters({id: info.id_tour, lang}))
  ...
  export const getUserRate =  info => async dispatch => {
    ...
    const rating = await DashBoard.post("/rate/get_service_user_rate.php"+ generatePHPParameters(info))
