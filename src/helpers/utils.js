...
const managePosts = (filtered) =>
  filtered.length > 9 ? filtered.splice(0, 9) : filtered;
...
const thousandsSeparatedAndFixed = (value, decimals = 2) =>
  addThousandsSeparator(parseFloat(value).toFixed(decimals));
...
const normalizePhoneInternational = (value) =>
...
const zipCodeText = (isInternational) =>
