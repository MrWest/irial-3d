    ...
    addToCart(
      {
        ...
        price: scene.price,
        lumion_version: scene.lumion_version,
        section,
        category,
        destination: scene.ownerInfo.stripe_account_id,
        file: scene.server_path,
        type: "scene",
      },
      openCart
    );
  ...
  render() {
    ...
    return (
      <main className={classes.container}>
        <Helmet>
          <title>Lumion Scenes |{scene.name}</title>
          ...
          <Grid container spacing={3} className={classes.center}>
            ...
            <Grid item md={8} xs={12}>
              ...
              <div style={{ paddingTop: 20 }}>
                <CommentsTool
                  ...
                  rate={scene.rate}
                  addComment={addSceneComment}
                  updateComment={updateSceneComment}
                  deleteComment={deleteSceneComment}
                ></CommentsTool>
              </div>
            </Grid>
            <Grid item md={4} xs={12}>
              ...
              <Grid container spacing={2} style={{ paddingTop: 24 }}>
                ...
                {scene.ownerInfo && (
                  <Grid xs={12}>
                    <p className={classes.sceneText} style={{ marginTop: 24 }}>
                    ...
                    <Grid container spacing={2} itemsAlign="center">
                      ...
                      <Grid item>
                        ...
                        >
                          {scene.ownerInfo.first_name}
                        </p>
                        <p
                          className={classes.sceneText}
                          style={{ marginBottom: 0 }}
                        >
                          {scene.ownerInfo.last_name}
                        </p>
                      </Grid>
                      <Grid item>
                        <p
                ...
                {scene.relatedScenes && (
                  <Grid container>
                    <p
                      ...
                      style={{ marginBottom: 16, marginTop: 24 }}
                    >
                      <strong>{language.RelatedScenes}:</strong>
                    </p>
                    <Grid container spacing={2}>
