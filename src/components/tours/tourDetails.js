            ...
            <Grid container spacing={4} className={classes.mobilePadding}>
              ...
              <Grid item xs={12} md={6}>
                <Grid container>
                  <Grid item xs={12} md={6}>
                    ...
                    <p>
                      <strong>{this.props.language.PickUpTime}:</strong>{" "}
                      {tour.pickup_time}
                    </p>
                  </Grid>
                  <Grid item xs={12} md={6} className={classes.onMoblie}>
                    <p style={{ paddingBottom: 16 }}>
                      <strong>{this.props.language.Guide}:</strong> {tour.guide}
                    </p>
                    <p>
                ...
                {tour.program.length > 0 && (
                  <Fragment>
                    ...
                    <ul
                      style={{ listStylePosition: "outside", display: "table" }}
                    >
                      {tour.program.map((prg) => (
                        ...
                        >
                          <p style={{ color: "#1c5375 !important" }}>
                            {this.programFormat(prg.content)}
                          </p>
                        </li>
                      ))}
                    </ul>
              ...
              >
                <ResourceTabs
                  ...
                  videos={tour.videos}
                  tabs={[
                    this.props.language.Images,
                    this.props.language.Videos,
                  ]}
                ></ResourceTabs>
                ...
                <div style={{ paddingTop: 20 }}>
                  <CommentsTool
                    ...
                    rate={tour.rate}
                    addComment={this.props.addTourComment}
                    updateComment={this.props.updateTourComment}
                    deleteComment={this.props.deleteTourComment}
                  ></CommentsTool>
                </div>
              </Grid>
            </Grid>
