  ...
  render() {
    ...
    return (
      <div className={classes.container} align="center">
        ...
        >
          <div>
            <p variant="p" component="p" align="left">
              Hi {"{Name}"},<br />
              Someone recently requested a password change for your SwagUp
              account. If this was you, press the button below:
            </p>
            ...
            <p variant="p" component="p" align="left" style={{ marginTop: 40 }}>
            ...
            <p variant="p" component="p" align="left" style={{ marginTop: 32 }}>
              Cheers!
              <br />
              <br />
              The SwagUp Team
