        ...
        <Form onSubmit={this.props.handleSubmit(this.realhandleSubmit.bind(this))}>
            ...
            <Grid container>
              ...
              <Grid item alignItems="baseline">
                  ...
                  >          
                    Edit the content to display for the current Tour, you can also customize the images on the right panel.
                  </Typography>
              </Grid>
            </Grid>
            ...
            <Grid item xs={12}  style={{ paddingTop: 10 }} >
                ...
                <Field
                  ...
                  <Grid item  xs={3} md={4} style={{ paddingTop: 25, fontSize: 8 }} alignItems="baseline" >
                    ...
                    <Grid item  xs={8} md={12} style={{ paddingTop: 10, fontSize: 8 }} >
                      <Field
                        name="note"
                        margin="small"
                        type="text"
            ...
            <Grid item xs={4} alignItems="flex-start" style={{ paddingTop: 0 }} align="right" className={classes.rightOnMobile}>
