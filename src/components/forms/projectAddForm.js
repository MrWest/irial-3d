...
import { addProject, notifyActivity } from "../../actions";
    ...
    addProject(data).then((project) => {
      if (project.id) {
        let message =
          ...
          " has added a new project business to vinalestraveler called: " +
          data.name;
                ...
                <Grid item xs={12}>
                  <Grid container>
                    ...
                    <Grid item alignItems="baseline">
                      ...
                      >
                        {language.AddFormTittle.format(language.Project)}
                      </Typography>
                      <Grid container>
                        <Grid item xs={2}>
                      ...
                      >
                        {language.AddFormText.format(language.Project)}
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
...
export default connect(mapStateToProps, { initialize, addProject })(
  reduxForm({ form: "projectAddForm", validate })(
    withStyles(styles)(withRouter(ProjectAddForm))
  )
);
