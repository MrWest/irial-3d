      ...
      return (
        ...
        <Form onSubmit={this.props.handleSubmit(this.realhandleSubmit.bind(this))}>
            ...
            <Grid container style={{paddingLeft: 18}} >
              ...
              >          
                Edit the content to display for the current Section, you can also customize the images on the right panel.
              </Typography>
            </Grid>           
            ...
            <Grid item xs={12} md={4} alignItems="flex-start" style={{ paddingTop: 0 }} align="center" className={classes.rightOnMobile}>
            ...
            <div style={{border: "1px #3577d4 solid", height: 200, width: 200, borderRadius: 100, display: "table"}}>
             ...
             {/* <CarouselTool>
               {this.props.section.images.map(image =>(
                 <img src={image.url} style={{width: "100%", height: 400}}></img>
               ))}
             </CarouselTool> */}
            </Grid>           
...
const mapStateToProps = state => {
  ...
  export default connect(
    mapStateToProps,
    { initialize, getSection, updateSection}
  )(
