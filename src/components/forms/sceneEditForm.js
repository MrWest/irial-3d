      ...
      reader.onload = (e) => {
        ...
        if (files[0] && files[0].size < 4200000) {
          ...
          this.props
            ...
            .then((res) => {
              this.props
                .selectModel(this.props.match.params.id)
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        >
                          <input
                            ...
                            onChange={this.uploadModel.bind(this)}
                            style={{ display: "none" }}
                          ></input>
                    ...
                    <div>
                      ...
                      >
                        <input
                          ...
                          name="fileToUpload"
                          id="fileToUpload"
                          disabled={!model.images || model.images.length > 9}
                    ...
                    <div>
                      ...
                      >
                        <input
                          ...
                          name="fileToUpload2"
                          id="fileToUpload2"
                          disabled={!model.videos || model.videos.length > 2}
                        ...
                        {tags.map((tag) => (
                          ...
                          >
                            <Tag
                              ...
                              tag={tag}
                              disabled={
                                !model.tags.find((t) => t.id === tag.id)
                              }
                              onClick={(activate) =>
                                toggleModelTags(model, tag.id, activate)
                              }
                            />
                          </Grid>
                        ))}
