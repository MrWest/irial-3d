    ...
    try {
      ...
      reader.onload = (e) => {
        ...
        if (files[0] && files[0].size < 4200000) {
          ...
          this.props
            .uploadTextureImage({
              textureId: this.props.texture.id,
              file: e.target.result,
              fileName: files[0].name,
              textureName: this.props.texture.name,
              onProgress: this.onUploadProgress,
            })
            .then((res) => {
              this.props
                .selectTexture(this.props.match.params.id)
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        >
                          <input
                            ...
                            onChange={this.uploadTexture.bind(this)}
                            style={{ display: "none" }}
                          ></input>
                    ...
                    <div>
                      ...
                      >
                        <input
                          ...
                          id="fileToUpload"
                          disabled={
                            !texture.images || texture.images.length > 9
                          }
                    ...
                    <div>
                      ...
                      >
                        <input
                          ...
                          id="fileToUpload2"
                          disabled={
                            !texture.videos || texture.videos.length > 2
                          }
                        ...
                        {tags.map((tag) => (
                          ...
                          >
                            <Tag
                              ...
                              tag={tag}
                              disabled={
                                !texture.tags.find((t) => t.id === tag.id)
                              }
                              onClick={(activate) =>
                                toggleTextureTags(texture, tag.id, activate)
                              }
                            />
                          </Grid>
                        ))}
