...
function CarouselContent({imageUrl, child, alt}){
  ...
  return (
                     <div style={{position: "relative",  textAlign: "center",}}>
                      <img alt={alt} style={{width: "100%", borderTopLeftRadius: 4, objectFit: "cover", maxHeight: 450 }} src={imageUrl}/>
    ...
    return (
      <div className={classes.root}>
        <div  className={classes.center} align="center">
          ...
          <Paper id={"front-tour-promo"} elevation={2} style={{ padding: 10, marginTop: -60, paddingBottom: 7}}>
...
export default connect(
  mapStateToProps
)( withStyles(styles)(FrontTourPromo));