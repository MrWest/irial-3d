    ...
    <Grid container className={classes.coverContact}>
          ...
          <Grid container>
            ...
            >
              <Grid item xs={12}>
                ...
                >
                  <strong>{language.Phone}:</strong> +53 54884414
                </p>
                <p
                  className={classes.typographyTextSmallBlue}
                  style={{ marginBottom: 16 }}
                ...
                <p
                  ...
                  style={{ marginBottom: 16 }}
                >
                  <strong>Email:</strong> solution3angle@gmail.com
                </p>
                <p
                  className={classes.typographyTextSmallBlue}
                  style={{ marginBottom: 16 }}
                >
                  <strong>Email:</strong> atlasenter84@gmail.com
                </p>
                <p className={classes.typographyTextSmallBlue}>
                  {" "}
                  <strong>Facebook:</strong> @solutiontriangle
                </p>
                <FacebookProvider appId="269776263974713">
                  <Like
                    href="http://www.facebook.com/vinalestraveler"
                    colorScheme="dark"
                    showFaces={true}
                    share
                  />
      ...
      <div
        style={{
          ...
          width: "100%",
          backgroundImage:
            "linear-gradient(rgba(255,255,255,0.6), transparent)",
        }}
      />
      <Grid
        container
...
export default connect(mapStateToProps)(withStyles(styles)(AboutContact));
