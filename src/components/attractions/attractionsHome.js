    ...
    return (
      <main ref={this.myRef} className={classes.container}>
        <Helmet>
          ...
          <title>
            {language.PageTittle} | {language.AttractionsPageTittle}{" "}
          </title>
          <meta
            name="description"
            content={language.AttractionsPageDescription}
          />
        ...
        <Grid container justify="center" spacing={0}>
          <Grid item className={classes.center}>
            ...
            <Grid item xs={12}>
              <DisplayAttractionsTool attractions={this.props.attractions} />
            </Grid>
          </Grid>
        </Grid>
        {busy && <Loader />}
...
export default connect(mapStateTopProps, { fetchAttractions, sortAttractions })(
  withStyles(styles)(AttractionsHome)
);
