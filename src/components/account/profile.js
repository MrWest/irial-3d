...
class Profile extends React.Component {
  ...
  stripeStatusMessage() {
    ...
    return profile.stripe_account_id
      ? "There are some errors or missing information on your stripe account. Please correct them using the stripe link, in order to set things up for collect payments."
        ...
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <Grid container alignItems="center">
              <Grid item>
                <p
                  style={{ fontSize: 32, fontWeight: "bold", marginBottom: 0 }}
                >
                  Profile{" "}
                  <span
                    style={{
              ...
              <Grid item>
                {profile.stripe_account_id ? (
                  <a
                    href={
                      profileStipeInfo && profileStipeInfo.linkUrl
                        ? profileStipeInfo.linkUrl
                        : loginLink
                    }
                  >
                    <Grid
...
export default connect(mapStateToProps, { initialize, reset, saveProfile })(
