...
class LanguageSelector extends React.Component {
  ...
  dataRequest(view, query, lang) {
    ...
    if (view === "sectionedit") getSection(query);
  ...
  handleChange = (value) => {
    if (value === "en") this.props.setLanguageEn();
    if (value === "es") this.props.setLanguageEs();
    ...
    if (params.length > 2) this.dataRequest(params[1], params[2], value);
    else {
      if (params[1] === "blog") this.props.fetchPosts();
      else this.props.fetchSections();
