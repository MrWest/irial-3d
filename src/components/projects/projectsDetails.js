    ...
    addToCart(
      {
        ...
        price: project.price,
        lumion_version: project.lumion_version,
        section,
        category,
        destination: project.ownerInfo.stripe_account_id,
        file: project.server_path,
        type: "project",
      },
      openCart
    );
  ...
  render() {
    ...
    return (
      <main className={classes.container}>
        <Helmet>
          <title>Lumion Projects |{project.name}</title>
          ...
          <Grid container spacing={3} className={classes.center}>
            ...
            <Grid item md={4} xs={12}>
              ...
              <p className={classes.projectText}>
                ...
                {project.lumion_version}
              </p>
              <p className={classes.projectPrice}>
                  ...
                  <Grid xs={12}>
                    ...
                    <Grid container spacing={2} itemsAlign="center">
                      ...
                      <Grid item>
                        ...
                        >
                          {project.ownerInfo.first_name}
                        </p>
                        <p
                          className={classes.projectText}
                          style={{ marginBottom: 0 }}
                        >
                          {project.ownerInfo.last_name}
                        </p>
                      </Grid>
                      <Grid item>
                        <p
                        ...
                        >
                          {project.ownerInfo.owner_projects}
                        </p>
                      </Grid>
                    </Grid>
                  </Grid>
                ...
                {project.relatedProjects && (
                  <Grid container>
                    <p
                      ...
                      style={{ marginBottom: 16, marginTop: 24 }}
                    >
                      <strong>{language.RelatedProjects}:</strong>
                    </p>
                    <Grid container spacing={2}>
