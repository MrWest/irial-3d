...
export const SELECT_LODGING = "SELECT_LODGING";
export const DELETE_LODGING = "DELETE_LODGING";
export const UPDATE_LODGING = "UPDATE_LODGING";
export const ADD_LODGING = "ADD_LODGING";
export const CHANGE_LODGING_PROGRAM = "CHANGE_LODGING_PROGRAM";
export const ADD_LODGING_COMMENT = "ADD_LODGING_COMMENT";
export const DELETE_LODGING_COMMENT = "DELETE_LODGING_COMMENT";
export const CHANGE_LODGING_COMMENT = "CHANGE_LODGING_COMMENT";
