...
export const fetchModels = () => async dispatch => {
 const modelsDb = await DashBoard.get("/models/get_models.php")
  ...
  export const sortModels = (category = 'all', sort='all', offset=0) => async dispatch => {
  ...
  export const sortModelsUser = user => async dispatch => {
    ...
    var modelsDb = undefined
     ...
     modelsDb = await DashBoard.post("/models/get_models_user.php"+ generatePHPParameters({user, lang}))
     ...
     const promises = modelsRslt.map( async model => {   
       ...
       const modelscommentsDb = await DashBoard.get("/models/get_model_comments.php"+ generatePHPParameters({idModel: model.id}))
       model.comments = modelscommentsDb.data
      
       const modelsvideosDb = await DashBoard.get("/models/get_model_videos.php"+ generatePHPParameters({idModel: model.id}))
  ...
  export const addModel = model => async dispatch => {
    ...
    const modelsDb = await DashBoard.post("/models/add_model.php", uploadInfo,  {headers})
  ...
  export const updateModel = model => async dispatch => {
    ...
    const modelsDb = await DashBoard.post("/models/update_model.php", uploadInfo,  {headers})
  
    var modelRslt = modelsDb.data
      
    const modelsImagesDb = await DashBoard.get("/models/get_model_images.php"+ generatePHPParameters({idModel: modelRslt.id}))
    modelRslt.images = modelsImagesDb.data

    const modelscommentsDb = await DashBoard.get("/models/get_model_comments.php"+ generatePHPParameters({idModel: modelRslt.id}))
    modelRslt.comments = modelscommentsDb.data
   
    const modelsvideosDb = await DashBoard.get("/models/get_model_videos.php"+ generatePHPParameters({idModel: modelRslt.id}))
  ...
  export const deleteModel = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/models/delete_model.php"+ generatePHPParameters({id}))
  ...
  export const deleteModelImage = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/models/delete_model_image.php"+ generatePHPParameters({id}))
  ...
  export const uploadModelVideo = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const modelAPI = await DashBoard.post("/models/upload_model_video.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const deleteModelVideo = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/models/delete_model_video.php"+ generatePHPParameters({id}))
  ...
  export const updateModelComment = comment => async dispatch => {
    ...
    const commentDb = await DashBoard.post("/models/update_model_comment.php", uploadInfo,  {headers})
  ...
  export const deleteModelComment = id => async dispatch => {
    ...
    await DashBoard.post("/models/delete_model_comment.php", uploadInfo,  {headers})
  ...
  export const rateModel = info => async dispatch => {
    ...
    const lang = getLanguage();
    const modelsDb = await DashBoard.post("/models/get_model.php"+ generatePHPParameters({id: info.id_model, lang}))
