 ...
 const attractionsDb = await DashBoard.get("/attractions/get_attractions.php")
  ...
  export const sortAttractionsUser = user => async dispatch => {
    ...
    var attractionsDb = undefined
     ...
     attractionsDb = await DashBoard.post("/attractions/get_attractions_user.php"+ generatePHPParameters({user, lang}))
  ...
  export const addAttraction = attraction => async dispatch => {
    ...
    const attractionsDb = await DashBoard.post("/attractions/add_attraction.php", uploadInfo,  {headers})
    ...
    const attractionsprogramDb = await DashBoard.get("/attractions/get_attraction_program.php"+ generatePHPParameters({idAttraction: attractionsRslt.id}))
  ...
  export const updateAttraction = attraction => async dispatch => {
    ...
    if(attraction.status){
      ...
      await DashBoard.post("/attractions/update_attraction_status.php", statusInfo,  {headers})
    ...
    const attractionsDb = await DashBoard.post("/attractions/update_attraction.php", uploadInfo,  {headers})
  
    var attractionRslt = attractionsDb.data
      
    const attractionsImagesDb = await DashBoard.get("/attractions/get_attraction_images.php"+ generatePHPParameters({idAttraction: attractionRslt.id}))
    attractionRslt.images = attractionsImagesDb.data

    const attractionsprogramDb = await DashBoard.get("/attractions/get_attraction_program.php"+ generatePHPParameters({idAttraction: attractionRslt.id, lang}))
    attractionRslt.program = attractionsprogramDb.data

    const attractionscommentsDb = await DashBoard.get("/attractions/get_attraction_comments.php"+ generatePHPParameters({idAttraction: attractionRslt.id}))
    attractionRslt.comments = attractionscommentsDb.data
   
    const attractionsvideosDb = await DashBoard.get("/attractions/get_attraction_videos.php"+ generatePHPParameters({idAttraction: attractionRslt.id}))
  ...
  export const deleteAttraction = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/attractions/delete_attraction.php"+ generatePHPParameters({id}))
  ...
  export const uploadAttractionImage = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const attractionAPI = await DashBoard.post("/attractions/upload_attraction_image.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const deleteAttractionImage = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/attractions/delete_attraction_image.php"+ generatePHPParameters({id}))
  ...
  export const uploadAttractionVideo = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const attractionAPI = await DashBoard.post("/attractions/upload_attraction_video.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const deleteAttractionVideo = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/attractions/delete_attraction_video.php"+ generatePHPParameters({id}))
  ...
  export const updateAttractionProgram = program => async dispatch => {
    ...
    const attractionsDb = await DashBoard.post("/attractions/update_attraction_program.php", uploadInfo,  {headers})
  ...
  export const addAttractionProgram = program => async dispatch => {
    ...
    const attractionsDb = await DashBoard.post("/attractions/add_attraction_program.php", uploadInfo,  {headers})
  ...
  export const deleteAttractionProgram = id => async dispatch => {
    ...
    const attractionsDb = await DashBoard.post("/attractions/delete_attraction_program.php", uploadInfo,  {headers})
  ...
  export const updateAttractionComment = comment => async dispatch => {
    ...
    const commentDb = await DashBoard.post("/attractions/update_attraction_comment.php", uploadInfo,  {headers})
  ...
  export const addAttractionComment = comment => async dispatch => {
    ...
    const commentDb = await DashBoard.post("/attractions/add_attraction_comment.php", uploadInfo,  {headers})
    var commentRslt = commentDb.data
     dispatch({
  ...
  export const deleteAttractionComment = id => async dispatch => {
    ...
    await DashBoard.post("/attractions/delete_attraction_comment.php", uploadInfo,  {headers})
  ...
  export const rateAttraction = info => async dispatch => {
    ...
    await DashBoard.post("/attractions/attraction_rate.php", uploadInfo,  {headers})


    const lang = getLanguage();
    const attractionsDb = await DashBoard.post("/attractions/get_attraction.php"+ generatePHPParameters({id: info.id_attraction, lang}))
