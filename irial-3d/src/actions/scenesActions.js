import { FETCH_SCENES, SELECT_SCENE , DELETE_SCENE, UPDATE_SCENE, ADD_SCENE, ADD_SCENE_COMMENT, DELETE_SCENE_COMMENT, CHANGE_SCENE_COMMENT, SET_USER_SERVICE_RATE} from "./types";
...
export const fetchScenes = () => async dispatch => {
 const scenesDb = await DashBoard.get("/scenes/get_scenes.php")
  ...
  export const sortScenesByCategoryUser = info => async dispatch => {
    ...
    // scenesDb = await DashBoard.get("/scenes/get_scenes.php"+ generatePHPParameters({lang}))
    //  else
     await DashBoard.get("/scenes/get_scenes_category_user.php"+ completeUrl).then( async scenesDb => {
  ...
  export const sortScenesUser = user => async dispatch => {
    ...
    var scenesDb = undefined
     ...
     scenesDb = await DashBoard.post("/scenes/get_scenes_user.php"+ generatePHPParameters({user, lang}))
     ...
     const promises = scenesRslt.map( async scene => {   
       ...
       const scenescommentsDb = await DashBoard.get("/scenes/get_scene_comments.php"+ generatePHPParameters({idScene: scene.id}))
       scene.comments = scenescommentsDb.data
      
       const scenesvideosDb = await DashBoard.get("/scenes/get_scene_videos.php"+ generatePHPParameters({idScene: scene.id}))
  ...
  export const addScene = scene => async dispatch => {
    ...
    const scenesDb = await DashBoard.post("/scenes/add_scene.php", uploadInfo,  {headers})
  ...
  export const updateScene = scene => async dispatch => {
    ...
    const scenesDb = await DashBoard.post("/scenes/update_scene.php", uploadInfo,  {headers})
  
    var sceneRslt = scenesDb.data
      
    const scenesImagesDb = await DashBoard.get("/scenes/get_scene_images.php"+ generatePHPParameters({idScene: sceneRslt.id}))
    sceneRslt.images = scenesImagesDb.data

    const scenescommentsDb = await DashBoard.get("/scenes/get_scene_comments.php"+ generatePHPParameters({idScene: sceneRslt.id}))
    sceneRslt.comments = scenescommentsDb.data
   
    const scenesvideosDb = await DashBoard.get("/scenes/get_scene_videos.php"+ generatePHPParameters({idScene: sceneRslt.id}))
  ...
  export const selectScene = id => async dispatch => {
    ...
    const sceneOwnerInfo = await DashBoard.get("/scenes/get_scene_owner_info.php"+ generatePHPParameters({user: scenesRslt.id_user}))
    scenesRslt = {...scenesRslt, ownerInfo: {...sceneOwnerInfo.data} };

    const sceneTags = await DashBoard.get("/tags/get_scene_tags.php"+ generatePHPParameters({id, lang}))
    scenesRslt = {...scenesRslt, tags: sceneTags.data };

    const sceneTagsReleted = await DashBoard.get("/tags/get_scene_tags_related_scenes.php"+ generatePHPParameters({id}))
  ...
  export const deleteScene = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/scenes/delete_scene.php"+ generatePHPParameters({id}))
  ...
  export const uploadSceneImage = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const sceneAPI = await DashBoard.post("/scenes/upload_scene_image.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const uploadSceneFile = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const sceneAPI = await DashBoard.post("/scenes/upload_scene_file.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const deleteSceneImage = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/scenes/delete_scene_image.php"+ generatePHPParameters({id}))
  ...
  export const uploadSceneVideo = info => async dispatch => {
    ...
    if(info.file !== null){
      ...
      const sceneAPI = await DashBoard.post("/scenes/upload_scene_video.php", uploadInfo,  {headers, onUploadProgress: info.onProgress});
  ...
  export const deleteSceneVideo = id => async dispatch => {
    ...
    const categoriesDb = await DashBoard.post("/scenes/delete_scene_video.php"+ generatePHPParameters({id}))
  ...
  export const updateSceneComment = comment => async dispatch => {
    ...
    const commentDb = await DashBoard.post("/scenes/update_scene_comment.php", uploadInfo,  {headers})
  ...
  export const addSceneComment = comment => async dispatch => {
    ...
    const commentDb = await DashBoard.post("/scenes/add_scene_comment.php", uploadInfo,  {headers})
  ...
  export const deleteSceneComment = id => async dispatch => {
    ...
    await DashBoard.post("/scenes/delete_scene_comment.php", uploadInfo,  {headers})
  ...
  export const rateScene = info => async dispatch => {
    ...
    const lang = getLanguage();
    const scenesDb = await DashBoard.post("/scenes/get_scene.php"+ generatePHPParameters({id: info.id_scene, lang}))
    ...
    const sceneTags = await DashBoard.get("/tags/get_scene_tags.php"+ generatePHPParameters({id: scenesRslt.id, lang}))
    scenesRslt = {...scenesRslt, tags: sceneTags.data };

    const sceneTagsReleted = await DashBoard.get("/tags/get_scene_tags_related_scenes.php"+ generatePHPParameters({id: scenesRslt.id}))
    scenesRslt = {...scenesRslt, relatedScenes: sceneTagsReleted.data };
