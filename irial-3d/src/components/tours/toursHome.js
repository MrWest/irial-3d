...
import { fetchTours, sortTours, fetchToursServer, sortToursServer } from "../../actions";
    ...
    return (
      <main ref={this.myRef}  className={classes.container}>
           <Helmet>
              ...
              <title>{language.PageTittle} | {language.ToursPageTittle} </title>
            ...
            <p style={{fontSize: 16, lineHeight: 1.3, color: '#0f2440 !important', fontFamily: 'Roboto !important'}}>
              ...
              <Grid item xs={12} md={4}>
                 <Grid item align="right">
                   ...
                   <InputLabel htmlFor="idsimple">{this.props.language.Filter}</InputLabel>
                  <Select
...
export default connect(mapStateTopProps, {fetchTours, sortTours, fetchToursServer, sortToursServer })(withStyles(styles)(ToursHome));
