...
class LodgingBookingForm extends React.Component {
  ...
  state = {emailStatus: undefined, isSending: false}
    ...
    realhandleSubmit =  async data => {
      ...
      if(data)
      {
        ...
        data.service = this.props.lodging.name + " Booking"
  ...
  render(){
    const { pristine, reset, submitting, classes, lodging } = this.props

    if(this.state.emailSendStatus)
       return <p > {this.state.emailSendStatus} </p>
      ...
      return (
        <Form onSubmit={this.props.handleSubmit(this.realhandleSubmit.bind(this))}>
          ...
          >          
            {this.props.language.LodgingsBookingText.format(lodging.name)}
          </p>
...
const mapStateToProps = state => {
  ...
  export default connect(
    ...
    reduxForm({ form: "lodgingBookingForm", enableReinitialize: true, validate })(
      withStyles(styles)(LodgingBookingForm)
    )
  );
