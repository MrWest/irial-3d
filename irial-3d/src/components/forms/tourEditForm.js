...
import {selectTour, updateTour, uploadTourImage, deleteTourImage,  uploadTourVideo, deleteTourVideo,  updateTourProgram, addTourProgram, deleteTourProgram,
  changeTourProgram} from "../../actions";
  ...
  handleChange2 = event => {
    ...
    realhandleSubmit = data => {
        ...
        reader.onload = e => {
         ...
         // console.log("xXx", files[0])
          ...
          if(files[0] && files[0].size < 4200000 ){
            ...
            this.props.uploadTourImage({tourId: this.props.tour.id, file:  e.target.result,
               fileName: files[0].name, tourName: this.props.tour.name, onProgress: this.onUploadProgress}).then(res=> {
  
                this.props.selectTour(this.props.match.params.id).then(()=> this.setState({completed: 0}));
               })
          }
          else
      ...
      selectVideoFile = event =>{
        ...
        try {
          ...
          reader.onload = e => {
            ...
            this.setState({imageData: e.target.result})
            this.props.uploadTourVideo({tourId: this.props.tour.id, file:  e.target.result,
               fileName: files[0].name, tourName: this.props.tour.name, onProgress: this.onUploadProgress}).then(res=> {
      ...
      handleProgramChange= event => {
        ...
        this.props.updateTourProgram({id: event.target.id, content: event.target.value, idTour: this.props.match.params.id})
       // this.props.selectTour(this.props.match.params.id)
      }

      addNewProgram= event => {

        this.props.addTourProgram({id_tour: this.props.match.params.id, content: "New activity",
      ...
      handleTextChange(event){
        ...
        this.props.changeTourProgram({id: event.target.id, content: event.target.value})
       }
           ...
           <Grid container>
             ...
             <Grid item className={classes.widthMobile}>
                 ...
                 <Grid item xs={6}>
                     ...
                     <div style={{display: "table", height: 40}}>
                        <div style={{display: "table-cell", verticalAlign: "middle"}}>
                         <Link to={"/tour/" + this.props.tour.id} style={{background: "#ffffff"}}>
                  ...
                  {this.props.sign.isLogged && this.props.sign.loginInfo &&
                    (this.props.sign.loginInfo.type === "admin") &&
                       <Grid item  xs={6} >
                        ...
                        <p style={{fontSize: 12, textAlign: "right", color: "#777", paddingRight: -16}} className={classes.rightOnMobile}>
                              {language.Status}
                        </p>
                        <Field
                               name="status"
           ...
           <Grid item xs={12} alignItems="flex-start" style={{ paddingTop: 0 }}>
            ...
            <Grid item xs={12}  style={{ paddingTop: 10 }} >
                ...
                <Field
                  ...
                  <Grid item xs={6} md={3}  style={{ paddingTop: 10, fontSize: 8 }} >
                      <Field
                        name="how_long"
                        margin="small"
                        type="text"
                  ...
                  <Grid item xs={3} md={4} style={{ paddingTop: 24, fontSize: 8 }} alignItems="baseline" >
                      <Field
                        name="guide"
                        type="text"
                        fullWidth
                  ...
                  <Grid item xs={9} md={12} style={{ paddingTop: 10, fontSize: 8 }} >
                      <Field
                        name="note"
                        margin="small"
                        type="text"
            ...
            <Grid item xs={12} md={5} alignItems="flex-start" style={{ paddingTop: 0 }} align="center">
                  ...
                  {this.props.tour.images&& (this.props.tour.images.length === 0 ? 
                  ...
                  :
                  <CarouselTool>
                  {this.props.tour.images && this.props.tour.images.map(image =>(
                  ...
                  <div>
                    ...
                    {this.props.tour.videos&& (this.props.tour.videos.length === 0 ? 
                    <div style={{border: "1px #3577d4 solid", height: 200, width: 200, borderRadius: 100, display: "table"}}>
                    ...
                    :
                    <CarouselTool>
                    {this.props.tour.videos && this.props.tour.videos.map(video =>(
                 ...
                 <TableHead>
                   ...
                   <TableBody>
                     {this.props.tour.program && this.props.tour.program.map((prog,index) =>(
                        ...
                        <TableCell className={classes.addCell}>
                        <RoundedButtonLink id={prog.id}  size={40} border={0} onClick={this.handleDeleteTourProgram.bind(this)} >
                                                        <DeleteIcon color="disabled" className="delete-icon" style={{fontSize: 34, background: "#ffffff", borderRadius: 34}}></DeleteIcon>
                                    </RoundedButtonLink>
                         </TableCell>
                        </TableRow>
...
const mapStateToProps = state => {
    return {
     ...
     sign: state.sign,
     initialValues:// state.selectedTour 
     {
  ...
  export default connect(
    mapStateToProps,
    { initialize, selectTour, updateTour, uploadTourImage, deleteTourImage,  uploadTourVideo, deleteTourVideo, 
      updateTourProgram, addTourProgram, deleteTourProgram, changeTourProgram}
  )(
