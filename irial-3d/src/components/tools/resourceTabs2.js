...
import TourCarouselTool from "./tourCarouselTool"
  ...
  function CarouselContent({imageUrl, child}){

    return (
                       <div style={{position: "relative",  textAlign: "center",}}>
                        <img style={{width: "100%", borderTopLeftRadius: 4, height: "50vh"}} src={imageUrl}/>
  ...
  function CarouselVideoContent({videoUrl, child}){
    ...
    return (
      ...
      <div style={{position: "relative",  textAlign: "center",}}>
                        ...
                        <Player
                            playsInline
                            style={{width: "100%", borderTopLeftRadius: 4, height: "50vh"}} 
                            src={videoUrl}
                            />
                            <div style={{position: "absolute", bottom: 0, left: "50%",transform: "translate(-50%, -50%)"}}>
    ...
    render() { 
        ...
        return ( 
            ...
            >
             ...
             {(images!==undefined && images.length>0) &&<Carousel
                      activeItem={0}
                    ...
                    <CarouselInner  >
                          {images.map( (img, index) => (
                              <CarouselItem itemId={index}>
                                <CarouselContent imageUrl={"/"+img.url} child={(<p style={{fontWeight: "bold", color: "#ffffff", textShadow: "1px 1px 0 rgba(0, 0, 0, 0.75)"}}>{img.caption}</p>)}/>
                              </CarouselItem>
                          ))}
                    </CarouselInner>
