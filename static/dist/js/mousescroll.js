!(function (e, t) {
  ...
  function r(e, t, n) {
    ...
    else for (var a = 0, r = e.length; a < r; a++) t.call(n, e[a], a, e);
  }
  function v(n, o) {
    var a = {};
    return (
  ...
  return (
    (o.animateScroll = function (a, r, e, t) {
      var c = v(c || y, e || {}),
        n = (function (e) {
          var t = {};
          return (
      ...
      var o,
        u,
        l,
        i = document.querySelector("[data-scroll-header]"),
      ...
      function b() {
        (u = 1 < (u = (h += 16) / parseInt(c.speed, 10)) ? 1 : u),
          (l =
            s +
            p *
              (function (e, t) {
          ...
          g.scrollTo(0, Math.floor(l)),
          (function (e, t, n) {
            var o = g.pageYOffset;
            (e == t || o == t || g.innerHeight + o >= m) &&
              (clearInterval(n), c.callbackAfter(a, r));
          })(l, d, o);
      }
      0 === g.pageYOffset && g.scrollTo(0, 0),
        c.callbackBefore(a, r),
        (o = setInterval(b, 16));
    }),
    (o.init = function (e) {
      if (a) {
        ...
        r(t, function (e) {
          e.addEventListener(
            "click",
            o.animateScroll.bind(null, e, e.hash, n),
            !1
          );
        });
      }
