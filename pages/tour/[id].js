...
import { selectTourServer, fetchSectionsServer, getCategoryServer } from "../../src/actions";
...
class TourDetailsServer extends Component {
  ...
  render() {
    ...
    return (
      <TourDetails tour={tour} categories={categories} />
    );
  }
}

TourDetailsServer.getInitialProps = async function({ reduxStore, query: { id } }) {
  console.log(id);
