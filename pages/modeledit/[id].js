...
import { selectModelServer, fetchSectionsServer, getCategoryServer } from "../../src/actions";
...
class ModelEditFormServer extends Component {
  render() {
    ...
    return (
      <ModelEditForm model={model} category={category} categories={categories}/>
    );
  }
}

ModelEditFormServer.getInitialProps = async function({ reduxStore, query: { id } }) {
  console.log(id);
